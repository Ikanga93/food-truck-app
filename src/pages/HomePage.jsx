    ...
    <>
      ...
      <section className="why-choose-us section">
        <div className="container">
          <h2 className="section-title">Why Choose Fernando's?</h2>
          <p className="section-subtitle">
            Experience authentic Mexican flavors with a story that spans generations
          </p>
            ...
            <div className="reviews-container">
              <div className="reviews-scroll">
                ...
                <div className="review-card">
                  ...
                  <p>Great food and always prepared to order. I've been eating Fernando for 10+ years!</p>
                </div>
                ...
                <div className="review-card">
                  ...
                  <p>These are the best tacos I've tried in the US. The al pastor tacos are my favorite! And the burritos are great too. I would highly recommend Fernandos and the food truck location in Campus Town is great.</p>
                </div>
                ...
                <div className="review-card">
                  ...
                  <p>As someone who grew up in Mexico, I have to say these are the best tacos in Champaign. They taste as good as any street taco you can get in Mexico. Also, the owner always greets you with a smile and makes you feel like a valued customer. Can't recommend this place enough.</p>
                </div>
              </div>
            </div>
          </div>
